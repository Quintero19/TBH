        ...
        const handleCancel = () => {
          ...
          return (
              ...
              <div className="grow p-6">
                <h1 className="text-5xl ml-10 font-bold mb-5 text-black">Agregar Roles</h1>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                    <h3 className="text-2xl text-black font-bold mb-2 block">Descripcion <span className="text-red-500">*</span></h3>
                    <input
                      type="text"
                      name="Descripcion"
