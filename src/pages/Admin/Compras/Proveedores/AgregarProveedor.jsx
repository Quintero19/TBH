...
return (
    ...
    <div className="md:ml-64 p-6 md:p-20">
        ...
        {formData.Tipo_Proveedor === "Empresa" && (
            <>
            <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                <h3 className="text-2xl text-black font-bold mb-2 block">NIT <span className="text-red-500">*</span></h3>
                <input
                type="text"
                name="NIT"
                value={formData.NIT}
            ...
            <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                <h3 className="text-2xl text-black font-bold mb-2 block">Nombre de la Empresa <span className="text-red-500">*</span></h3>
                <input
                type="text"
                name="Nombre_Empresa"
            ...
            <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                <h3 className="text-2xl text-black font-bold mb-2 block">Celular Empresa <span className="text-red-500">*</span></h3>
                <input
                type="text"
            ...
            <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                <h3 className="text-2xl text-black font-bold mb-2">Celular Asesor</h3>
                <input
                type="text"
                name="Celular_Asesor"
