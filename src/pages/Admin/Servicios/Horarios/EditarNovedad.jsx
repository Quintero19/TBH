		...
		const fetchNovedad = async () => {
			try {
				...
				if (fechaHora - ahora < tresHoras) {
					showAlert(
						"No se puede modificar la novedad porque faltan menos de 3 horas para la hora de inicio.",
						{
							type: "warning",
				...
				showAlert("Error al cargar la novedad", {
					type: "error",
					title: "Error",
				});
			}
		...
		<>
			...
			>
				...
				<div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg m-7 mt-2">
					<h3 className="text-2xl text-black font-bold mb-2">Empleado</h3>
					<input
						type="text"
