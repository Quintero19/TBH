                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                        ...
                        {validationErrors.TipoDocumento && (
                            <p className="text-red-500 text-sm mt-1">{validationErrors.TipoDocumento}</p>
                        )}
                    </div>
                    ...
                    <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                        ...
                        {validationErrors.Documento && (
                            <p className="text-red-500 text-sm mt-1">{validationErrors.Documento}</p>
                        )}
                    </div>
                    ...
                    <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                        ...
                        {validationErrors.Celular && (
                            <p className="text-red-500 text-sm mt-1">{validationErrors.Celular}</p>
                        )}
                    </div>
                    ...
                    <div className="p-7 bg-white shadow border-2 border-gray-200 rounded-lg md:col-span-1 m-7 mt-2">
                        ...
                        {validationErrors.FechaNacimiento && (
                            <p className="text-red-500 text-sm mt-1">{validationErrors.FechaNacimiento}</p>
                        )}
                    </div>
